...
<body>
    ...
    <div class="product">
        ...
        <img src="./images/hardware5.jpg" alt="Product Image">
        <div class="product-details">
            <h4>MSI Optix G32C4X 32” INCH 250HZ CURVED GAMING Monitor VA PANEL | FHD | 250Hz | Adaptive sync | CURVED </h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs. 110,500/=</span> Rs. 103,000/=
            </div>
...
<div class="product">
        ...
        <img src="./images/hardware6.jpg" alt="Product Image">
        <div class="product-details">
            <h4>MSI Optix G32C4X 32” INCH 250HZ CURVED GAMING Monitor VA PANEL | FHD | 250Hz | Adaptive sync | CURVED </h4>
            <div class="status">In Stock</div>
            <div class="price">
