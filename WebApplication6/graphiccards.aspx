...
<body>
    ...
    <div class="product">
        ...
        <img src="./images/gr1.jpg" alt="Product Image">
        <div class="product-details">
            <h4>MSI GEFORCE GT 1030 4GB AERO ITX GDDR4 GRAPHICS CARD GEFORCE | GT 1030 | 4GB GDDR4</h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs. 39,000/=</span> Rs. 38,000/=
            </div>
    ...
    <div class="product">
        ...
        <div class="product-details">
            ...
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs. 31,000/=</span> Rs. 30,000/=
            </div>
            <a href="customerorder.aspx" class="add-to-cart">ORDER</a>
        </div>
    </div>
