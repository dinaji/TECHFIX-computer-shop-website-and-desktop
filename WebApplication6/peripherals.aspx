...
<body>
    ...
    <div class="product">
        ...
        <img src="./images/pe1.jpg" alt="Product Image">
        <div class="product-details">
            <h4>TECH-BUILD Intel® Core i3-10105 10th Gen Custom Build Budget Desktop Computer ECH-BUILD | Assemble | Intel® Core i3-10105 | 8GB </h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs. 90,500/=</span> Rs. 90.000/=
            </div>
        ...
        <img src="./images/pe2.jpg" alt="Product Image">
        <div class="product-details">
            <h4>TECH-BUILD Intel® Core i3-10105 10th Gen Custom Build Budget Desktop Computer ECH-BUILD | Assemble | Intel® Core i3-10105 | 8GB </h4>
            <div class="status">In Stock</div>
            <div class="price">
        ...
        <img src="./images/pe4.jpg" alt="Product Image">
        <div class="product-details">
            <h4>TECH-BUILD Intel® Core i3-10105 10th Gen Custom Build Budget Desktop Computer ECH-BUILD | Assemble | Intel® Core i3-10105 | 8GB </h4>
            <div class="status">In Stock</div>
            <div class="price">
