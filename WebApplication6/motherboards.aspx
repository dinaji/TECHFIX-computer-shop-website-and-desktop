...
<body>
    ...
    <div class="product">
        ...
        <div class="product-details">
            <h4>ASUS PRIME H610M-E D4 Motherboard ‎Intel® | H610 | LGA 1700</h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs. 40,000/=</span> Rs. 38,000/=
            </div>
    ...
    <div class="product">
        ...
        <img src="./images/motherboard2.jpg" alt="Product Image">
        <div class="product-details">
            <h4>GIGABYTE H410M H V2 Motherboard ‎Intel® | H410 | 1200 SOCKET</h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs  30,000/=</span> Rs 26,500/=
            </div>
            <a href="customerorder.aspx" class="add-to-cart">ORDER</a>
        </div>
    </div>
    ...
    <div class="product">
       <span class="badge new">NEW</span>
        ...
        <img src="./images/hardware8.jpg" alt="Product Image">
        <div class="product-details">
            <h4>GIGABYTE H410M H V2 Motherboard ‎Intel® | H410 | 1200 SOCKET</h4>
            <div class="status">In Stock</div>
            <div class="price">
                <span class="old-price">Rs 45,000/=</span> Rs 42,000/=
            </div>
             <a href="customerorder.aspx" class="add-to-cart">ORDER</a>
        </div>
    </div>
